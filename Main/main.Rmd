...
=======
                        trace = 0,
                        B = 100) {
>>>>>>> 83cbe9c8e27ee5993e4d125b2a199d7962c69fdc
...
=======
    ...
    results$gbFullMCAR <- gradBM(trainMCAR, testMCAR, ntrees = 1000, shrinkage = 1, verbose = trace > 1, full = TRUE)
    results$gbFullMAR <- gradBM(trainMAR, testMAR, ntrees = 1000, shrinkage = 1, verbose = trace > 1, full = TRUE)
    results$gbFullMARwR <- gradBM(trainMARwR, testMARwR, ntrees = 1000, shrinkage = 1, verbose = trace > 1, full = TRUE)
>>>>>>> 83cbe9c8e27ee5993e4d125b2a199d7962c69fdc
  }
...
=======
    ...
    results$forestMCAR <- survForest(trainMCAR, testMCAR)
    results$forestMAR <- survForest(trainMAR, testMAR)
    results$forestMARwR <- survForest(trainMARwR, testMARwR)
>>>>>>> 83cbe9c8e27ee5993e4d125b2a199d7962c69fdc
  }
