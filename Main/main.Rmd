...
trainModels <- function(train, 
  ...
  if("GBfull" %in% methods) {
    ...
    results$gbFullMCAR <- gradBM(trainMCAR, testMCAR, ntrees = 1000, shrinkage = 1, verbose = trace > 1, full = TRUE, save.object = save.object)
    results$gbFullMAR <- gradBM(trainMAR, testMAR, ntrees = 1000, shrinkage = 1, verbose = trace > 1, full = TRUE, save.object = save.object)
    results$gbFullMARwR <- gradBM(trainMARwR, testMARwR, ntrees = 1000, shrinkage = 1, verbose = trace > 1, full = TRUE, save.object = save.object)
  }
  ...
  if("Forest" %in% methods) {
    ...
    results$forestMARwR <- survForest(trainMARwR, testMARwR, save.object = save.object)
  }
